...
public class Door : MonoBehaviour {
	...
	void Start () {
		...
		leftDoorStartRotation = leftDoor.transform.rotation;
     	leftDoorEndRotation = Quaternion.Euler(270f, 0f, 0f);
		rightDoorStartRotation = rightDoor.transform.rotation;
     	rightDoorEndRotation = Quaternion.Euler(-90f, 90f, -90f);
	}
	...
	void Update () {
		...
		if (opening) {
			...
			leftDoor.transform.rotation = Quaternion.Slerp (leftDoorStartRotation, leftDoorEndRotation, Time.time/rotationTime);
			rightDoor.transform.rotation = Quaternion.Slerp (rightDoorStartRotation, rightDoorEndRotation, Time.time/rotationTime);
